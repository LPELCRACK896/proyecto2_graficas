...
rtx.lights.append( PointLight(point = (-5,0,2)))

rtx.scene.append( Sphere(V3(-3+centrox,3+centroy,-10), 1, extra)  )
...
rtx.scene.append( Sphere(V3(-3+centrox,0+centroy,-10),1, earth)  )
